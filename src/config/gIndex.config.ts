...
const config: z.input<typeof Schema_Config> = {
  ...
  apiConfig: {
     ...
     */
    rootFolder:
      "f97e5b44bb570ed92678157df2b232499b1432aab6483323bd9952a3c8962cadfefc32f6f1408908e0ba94c2637f2d90ff;281ddbc6bc5fe3a6f1c985e3",
